...
const ProfileModal = ({ profiles, activeProfileId, onSwitch, onCreate, onDelete, onRename, onClose, onOpenMerge, onOpenCopy, canClose = true }) => {
        ...
        {!canClose && (
          <div className="px-5 pt-3">
            <p className="text-xs text-blue-600 bg-blue-50 rounded-xl px-3 py-2">
              👋 Създайте първи профил, за да продължите.
            </p>
          </div>
        )}
          ...
          {showCreate ? (
            ...
            <div className="flex flex-col gap-2">
              ...
              <button onClick={() => { onClose(); onOpenMerge(); }} className="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-sm font-medium bg-blue-50 text-blue-600 hover:bg-blue-100 transition">
                <Download className="w-4 h-4" /> Импортирай данни от резервно копие от друг профил
              </button>
